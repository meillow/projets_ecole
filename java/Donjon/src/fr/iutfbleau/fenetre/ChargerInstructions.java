 ...
 * d'afficher les instructions.
 *
 * @version 1.0
 * @author Marie Pellier, Antoni Blanche
 */
public class ChargerInstructions extends ChangerFenetre
{
   ...
   * @param f la fenêtre
   */
  public ChargerInstructions(Fenetre f)
  {
    super(f);
  }
  ...
  {
    this.fenetre.afficher(Fenetre.INSTRUCTIONS);
  }
}
