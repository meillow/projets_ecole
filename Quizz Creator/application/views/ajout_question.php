...
<form method="post" action="<?php echo site_url('user/enregistrer_question') ?>">
  <div align=center>

    <div>
      <label  for="ques_libele">Libelle question <?php echo $num_question; ?></label>
    ...
    <label  for="ques_libele">Entrez les réponses possibles (de 2 à 4), 
            et choisissez la/les ou aucune bonne réponse. 
    </label>
